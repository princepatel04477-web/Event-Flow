...
**Stopped — static export deferred to v2 (decided 12 August 2026)**

`feat/m2-static-export-bundle` is pushed and parked. Do not resume it before the event.
The event build is the remote shell — see §11a. Branch state:
...
Left as-is deliberately: the branch is a pushed recoverability anchor and rewriting it
to fix a cosmetic defect is a worse trade than the defect.
