...
/**
 * Hand-rolled 24px stroke icons. No icon package — every kilobyte matters on
 * venue Wi-Fi, and we only need a dozen glyphs.
 *
 * Size them with a class (`h-5 w-5`); the width/height attributes are only a
 * fallback for when CSS has not loaded yet.
 */
...
/**
 * A chat bubble, not the WhatsApp glyph. The brand mark is trademarked and
 * shipping it would also make the button look like an integration; this is a
 * deep link to whatever WhatsApp the phone already has.
 */
