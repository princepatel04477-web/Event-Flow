...
export function CallScreen({
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <>
        {/* The caller lock is claimed and released on the RSVP status screen
            (rsvp/status/[groupId]) only. This call screen neither claims nor
            releases — it only stamps last_opened_by_staff presence. */}
